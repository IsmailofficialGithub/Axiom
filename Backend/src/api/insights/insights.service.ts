...
export const getTopOpportunities = async (userRole: string, userId: string, filters: any = {}) => {
  ...
  if (filters.sector && filters.sector !== 'all') {
    ...
    let ilikePattern = '';
    if (sector === 'saas') ilikePattern = '%saas%';
    else if (sector === 'fintech') ilikePattern = '%fintech%';
    else if (sector === 'healthtech') ilikePattern = '%healthtech%';
    else if (sector === 'ai_ml') ilikePattern = '%ai%';
    else if (sector === 'cleantech') ilikePattern = '%clean%';
