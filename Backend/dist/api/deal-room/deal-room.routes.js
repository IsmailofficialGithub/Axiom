 ...
 */
router.post('/opportunities/:opportunityId/documents', authorize('startup', 'admin'), validate(uploadDocumentSchema), dealRoomController.addDocument);
/**
 * @openapi
 ...
 */
router.post('/opportunities/:opportunityId/permissions', authorize('startup', 'admin'), validate(grantPermissionSchema), dealRoomController.grantAccess);
