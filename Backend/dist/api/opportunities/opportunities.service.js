...
export const listOpportunities = async (userRole, userId, filters = {}) => {
...
export const getOpportunityById = async (id, userRole, userId) => {
...
export const updateOpportunity = async (id, userId, userRole, data) => {
    ...
    if (userRole !== 'admin') {
        ...
        if (existing.created_by !== userId)
            throw new ApiError(403, 'You can only update your own opportunities');
    }
