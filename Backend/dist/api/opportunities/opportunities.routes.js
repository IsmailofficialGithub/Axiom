 ...
 */
router.post('/', authorize('startup', 'admin'), validate(createOpportunitySchema), oppsController.create);
/**
 * @openapi
 * /api/v1/opportunities/{id}:
 *   patch:
 ...
 */
router.patch('/:id', authorize('startup', 'admin'), validate(updateOpportunitySchema), oppsController.update);
